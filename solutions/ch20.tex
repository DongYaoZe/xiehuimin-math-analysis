...
\begin{enumerate}[label=(\arabic*)]
  ...
  \]
  在 $r\ne0$ 的区域内，原方程等价于 $q=\tan q$。连续隐函数支上的 $q$ 必须落在方程 $q=\tan q$ 的某个孤立根上，因此在足够小的连通邻域内 $q$ 为常数。于是 $z=qr$，从而
  \[
...
\end{xexercise}
\begin{xsolution}
下文 $f_i,f_{ij}$ 均表示 $f$ 对相应自变量的偏导，并在题目所给复合自变量处取值。
...
令 $W=g(V)$。由于 $Jg$ 可逆，$W$ 是 $x_0$ 的开邻域，并且
\[
  f\colon W\to V,
