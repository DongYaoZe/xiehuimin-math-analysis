...
\chapter*{第24章\quad 曲线积分习题解答}
\addcontentsline{toc}{chapter}{第24章\quad 曲线积分习题解答}
...
\begin{itemize}
  \item 把一只圆形碗中的粥视为圆盘，并连续搅动后让每一粒米对应到它的新位置；只要米粒始终留在碗内，这个连续自映射至少有一个不动点，即至少有一粒米最终回到原来的位置；
